<template>
    <div class="font-sans flex flex-col justify-center">
        <div class="felx mt-8 text-center uppercase font-bold text-darkgray text-2xl">
            <p>edit product</p>
        </div>
        <div class="flex justify-center text-left my-4">
            <div class="bg-darkgray rounded-md p-4 w-2/3">
                                ...
                                <div class="mt-2 w-3/5 space-y-1">
                                    ...
                                    <div class="grid grid-cols-10 justify-items-start">
                                        <div v-for="color in colors" :key="color.colorId"  >
                                           ...
                                           <div class="w-8 h-8 rounded-md" :style="{ background: color.colorName }"></div>
                                        </div>
                                    </div>
        ...
        <!-- <div class="flex justify-center mb-4">
            <div class=" h-96 border-0 rounded-md shadow-lg flex flex-col w-3/4 bg-darkgray">
